...
$(function() {
    ...
    ui.accountsWorkGrid = new ej.grids.Grid({
        ...
        filterSettings: { type: 'Excel' },
        width: "100%",
        toolbar: [{ id: "print", prefixIcon: "e-print", tooltipText: "imprimir" },{ type: "Separator" }, { template: '#toolbarTemplate' }],
        editSettings: { showConfirmDialog: true, showDeleteConfirmDialog: true, allowEditing: true, allowAdding: true, allowDeleting: true, mode: 'Batch' },
        //selectionSettings: { cellSelectionMode: 'BoxWithBorder', mode: 'Cell' },
        width: "100%",
        columns: [
            { field: "policyId", visible: false },
            { field: 'policyCode', headerText: '<h5>asiento</h5>', disableHtmlEncode: false, width: '15%' },
            ...
            { field: "description", headerText: "<h5>descripcion</h5>", disableHtmlEncode: false, width: '39%' },
